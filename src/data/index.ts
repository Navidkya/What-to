...
export const DATA: Record<string, DataItem[]> = {
  ...
  do: [
    { title: 'Sunset no Miradouro da Graça', year: 'Gratuito · 2h', type: 'Exterior', genre: 'Natureza', rating: 9.4, desc: 'Manta, vinho, ver Lisboa mudar de cor. Grátis e perfeito.', emoji: '🌆', custo: 'gratuito', local: 'exterior', platforms: [{ n: 'Maps', url: 'https://maps.google.com/?q=Miradouro+da+Graca+Lisboa', c: '#4285F4' }] },
    { title: 'Sauna + Mergulho Frio', year: '1-2h · A dois', type: 'A dois', genre: 'Bem-estar', rating: 9.0, desc: 'Contraste de calor e frio que repõe energias. Vários espaços em Lisboa.', emoji: '🧖', custo: 'baixo', local: 'exterior', platforms: [{ n: 'Pesquisar', url: 'https://www.google.com/search?q=sauna+mergulho+frio+Lisboa', c: '#4285F4' }] },
    ...
    { title: 'Noite de jogos de tabuleiro', year: '2-4h · Casa', type: 'Interior', genre: 'Social', rating: 9.0, desc: 'Catan, Ticket to Ride, ou um baralho. Melhor com 3-5 pessoas e snacks.', emoji: '🎲', custo: 'gratuito', local: 'interior', platforms: [] },
    { title: 'Visita ao mercado local', year: '1-2h · Manhã', type: 'Exterior', genre: 'Social', rating: 8.5, desc: 'Mercado da Ribeira ou Feira da Ladra. Fruta, queijo, conversa, atmosfera.', emoji: '🛒', custo: 'gratuito', local: 'exterior', platforms: [{ n: 'Maps', url: 'https://maps.google.com/?q=Mercado+da+Ribeira+Lisboa', c: '#4285F4' }] },
    { title: 'Noite de escrita criativa', year: '1-2h · Casa', type: 'Interior', genre: 'Criativo', rating: 8.4, desc: 'Um tema, 30 minutos, sem julgamentos. Surpreende-te com o que sai.', emoji: '✍️', custo: 'gratuito', local: 'interior', platforms: [] },
    { title: 'Passeio nocturno pela cidade', year: '1-2h · Noite', type: 'Exterior', genre: 'Natureza', rating: 8.9, desc: 'Lisboa à noite tem uma luz diferente. Escolhe um bairro e perde-te.', emoji: '🌙', custo: 'gratuito', local: 'exterior', platforms: [] },
    { title: 'Sessão de fotografia urbana', year: '2h · Qualquer hora', type: 'Exterior', genre: 'Criativo', rating: 8.7, desc: 'Só com o telemóvel. Texturas, sombras, pessoas. Vês a cidade de forma diferente.', emoji: '📷', custo: 'gratuito', local: 'exterior', platforms: [] },
    { title: 'Maratona de um realizador', year: '4-6h · Casa', type: 'Interior', genre: 'Criativo', rating: 8.8, desc: 'Escolhe um realizador (Nolan, Kubrick, Almodovar) e vê 2-3 filmes seguidos.', emoji: '🎞️', custo: 'gratuito', local: 'interior', platforms: [] },
    { title: 'Piquenique com vista', year: '2-3h · Dia', type: 'Exterior', genre: 'Natureza', rating: 9.2, desc: 'Prepara a cesta, escolhe um miradouro. Simples e sempre bom.', emoji: '🧺', custo: 'gratuito', local: 'exterior', platforms: [] },
    { title: 'Aprender um origami', year: '30min · Casa', type: 'Interior', genre: 'Criativo', rating: 8.2, desc: 'Papel e um tutorial no YouTube. Grua, caixa, flor. Meditativo e gratificante.', emoji: '🦢', custo: 'gratuito', local: 'interior', platforms: [{ n: 'YouTube', url: 'https://www.youtube.com/results?search_query=origami+tutorial+beginner', c: '#FF0000' }] },
    { title: 'Noite de cocktails em casa', year: '1-2h · Noite', type: 'Interior', genre: 'Social', rating: 8.9, desc: 'Escolhe dois clássicos (Negroni, Old Fashioned) e aprende a fazê-los bem.', emoji: '🍸', custo: 'baixo', local: 'interior', platforms: [{ n: 'YouTube', url: 'https://www.youtube.com/results?search_query=cocktail+recipe+negroni', c: '#FF0000' }] },
    { title: 'Visita a um museu gratuito', year: '1-2h · Dia', type: 'Exterior', genre: 'Cultura', rating: 8.6, desc: 'MNAC, Berardo, Museu do Dinheiro. Em Lisboa há mais do que pensas de borla.', emoji: '🏛️', custo: 'gratuito', local: 'exterior', platforms: [{ n: 'Pesquisar', url: 'https://www.google.com/search?q=museus+gratuitos+Lisboa', c: '#4285F4' }] },
  ],
};
...
export const WHY_EXTRA: Record<string, WhyReason[]> = {
  ...
  do: [
    ...
    { icon: '↗', l: 'Quero sair', s: 'Atividade exterior', p: 'local', v: 'exterior' },
